...
public partial class GameEntity {
    ...
    public Code.Infrastructure.Entities.View.IEntityView View { get { return view.Value; } }
    public bool hasView { get { return HasComponent(GameComponentsLookup.View); } }

    public GameEntity AddView(Code.Infrastructure.Entities.View.IEntityView newValue) {
    ...
    public GameEntity ReplaceView(Code.Infrastructure.Entities.View.IEntityView newValue) {
        var index = GameComponentsLookup.View;
        var component = (Code.Common.View)CreateComponent(index, typeof(Code.Common.View));
        component.Value = newValue;
