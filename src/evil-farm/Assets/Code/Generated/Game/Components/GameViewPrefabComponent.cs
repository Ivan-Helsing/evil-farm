...
public partial class GameEntity {
    ...
    public Code.Infrastructure.Entities.View.EntityBehaviour ViewPrefab { get { return viewPrefab.Value; } }
    public bool hasViewPrefab { get { return HasComponent(GameComponentsLookup.ViewPrefab); } }

    public GameEntity AddViewPrefab(Code.Infrastructure.Entities.View.EntityBehaviour newValue) {
    ...
    public GameEntity ReplaceViewPrefab(Code.Infrastructure.Entities.View.EntityBehaviour newValue) {
        var index = GameComponentsLookup.ViewPrefab;
        var component = (Code.Common.ViewPrefab)CreateComponent(index, typeof(Code.Common.ViewPrefab));
        component.Value = newValue;
