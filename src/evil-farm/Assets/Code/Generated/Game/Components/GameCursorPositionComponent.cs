...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Input.CursorPosition cursorPosition { get { return (Code.Gameplay.Features.Input.CursorPosition)GetComponent(GameComponentsLookup.CursorPosition); } }
    ...
    public GameEntity AddCursorPosition(UnityEngine.Vector2 newValue) {
        ...
        var component = (Code.Gameplay.Features.Input.CursorPosition)CreateComponent(index, typeof(Code.Gameplay.Features.Input.CursorPosition));
